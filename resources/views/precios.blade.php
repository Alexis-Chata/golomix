<x-app-layout>
    ...
    @push('title')
        <title>{{ __('Productos Precios') }}</title>
    @endpush

    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Productos Precios') }}
        </h2>
    </x-slot>
            ...
            <div id='productos_pdf' class="p-2 bg-white dark:bg-gray-800 shadow-xl sm:rounded-lg">
                <div class="row d-inline-block">
                    <div class="col-xl-12 text-right">
                        ...
                        <a href="{{ route('ProductosDescargarExcel', [$precioMayorista ? '002' : '001']) }}"
                            class="btn btn-success btn-sm" id="productos_excel">
                            <button type="button" class="pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                    <path
                ...
                <table id="example" class="display" style="width:100%">
                    <thead>
                        <tr>
                            <th>Cod</th>
                            <th>Productos Precios</th>
                            <th style="text-align: center;">Precio Unidad B</th>
                        ...
                        @foreach ($com01s as $com01)
                            <tr class="{{ $com01->flagcre == 1 ? 'anulado' : '' }}">
                                ...
                                <td style="text-align: center;">{{ $com01->cc04 }} -
                                    ...
                                    {{ $com01->tipo_producto_id == 5 ? '- PROMOS' : '' }}
                                </td>
