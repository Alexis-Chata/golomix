    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('allProductosMayorista') }}"
                        :active="request()->routeIs('allProductosMayorista')">
                        {{ __('P.Mayorista') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('listaclientes') }}"
                        :active="request()->routeIs('listaclientes') || request()->routeIs('listaclientesXvendedor')">
                        {{ __('Lista Clientes') }}
                    </x-nav-link>

                    @php
                    $classes_nav_link = (request()->routeIs('dashboard') ?? false)
                                ? 'inline-flex items-center px-1 pt-1 border-b-2 border-indigo-400 dark:border-indigo-600 text-sm font-medium leading-5 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
                                : 'inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-700 focus:outline-none focus:text-gray-700 dark:focus:text-gray-300 focus:border-gray-300 dark:focus:border-gray-700 transition duration-150 ease-in-out';
                    @endphp

                    <!-- Settings Dropdown -->
                    <div id="dropdown_custom" class="sm:flex sm:items-center sm:ml-6 {{ $classes_nav_link }}">
                    ...
                    <x-nav-link href="{{ route('allpedidosXtransporte') }}"
                        :active="request()->routeIs('allpedidosXtransporte')">
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                ...
                                <button
                                    ...
                                    <img class="min-w-min h-8 w-8 rounded-full object-cover"
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link href="{{ route('listaclientes') }}"
                    :active="request()->routeIs('listaclientes') || request()->routeIs('listaclientesXvendedor')">
                    {{ __('Lista Clientes') }}
                </x-responsive-nav-link>
                ...
                <!-- Settings Dropdown -->
                @php
                $classes_responsive_nav_link = (request()->routeIs('dashboard') ?? false)
                ...
                <x-responsive-nav-link href="{{ route('allpedidosXtransporte') }}"
                    :active="request()->routeIs('allpedidosXtransporte')">
                    {{ __('Distribucion de Carga') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link href="{{ route('allVendedorRutas') }}"
                    :active="request()->routeIs('allVendedorRutas')">
                    {{ __('Distribucion de Rutas') }}
                </x-responsive-nav-link>
            </div>
