    ...
    <div class="gap-6 grid grid-cols-1 md:grid-cols-2">
        <div class="py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="row px-6">
                        <form action="{{ route('com36.store') }}" class="py-6" method="post" enctype="multipart/form-data" title="Pedidos">
                            @csrf
        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="row px-6">
                        <form action="{{ route('com37.store') }}" class="py-6" method="post" enctype="multipart/form-data"  title="Detalle Pedidos">
                            @csrf
        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="row px-6">
                        <form action="{{ route('com30.store') }}" class="py-6" method="post" enctype="multipart/form-data" title="Rutas">
                            @csrf
        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="row px-6">
                        <form action="{{ route('com01.store') }}" class="py-6" method="post" enctype="multipart/form-data" title="Productos">
                            @csrf
        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="row px-6">
                        <form action="{{ route('ugr01.store') }}" class="py-6" method="post" enctype="multipart/form-data" title="Marca de Productos">
                            @csrf
        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="row px-6">
                        <form action="{{ route('com07.store') }}" class="py-6" method="post" enctype="multipart/form-data" title="Clientes">
                            @csrf
