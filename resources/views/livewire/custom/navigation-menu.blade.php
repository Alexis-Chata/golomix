                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if ($cvens->count())
                        ...
                        @if (
                            $cvens->count() > 1 ||
                                auth()->user()->hasRole('Super-Admin'))
                            <x-custom.nav-dropdown :cvens="$cvens" :com10s="$com10s" titulo="Lista Clientes" nameRoute="listaclientesXvendedor" allroute="listaclientes" />
                        @else
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if ($cvens->count())
                ...
                @else
                    <x-responsive-nav-link href="{{ route('pedidos', $cvens->first()) }}" :active="request()->routeIs('allpedidos') || request()->routeIs('pedidos')">
                        {{ __('Pedidos') }}
                        </x-nav-link>
                @endif
            ...
            @if ($cvens->count())
                ...
                @if (
                    $cvens->count() > 1 ||
                        auth()->user()->hasRole('Super-Admin'))
                    <x-custom.responsive-nav-dropdown :cvens="$cvens" :com10s="$com10s" titulo="Lista Clientes" nameRoute="listaclientesXvendedor" allroute="listaclientes" />
                @else
                    <x-responsive-nav-link href="{{ route('listaclientesXvendedor', $cvens->first()) }}" :active="request()->routeIs('listaclientes') || request()->routeIs('listaclientesXvendedor')">
                        {{ __('Lista Clientes') }}
                    </x-responsive-nav-link>
                @endif
