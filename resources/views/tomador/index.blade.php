            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <input class="form-control" type="text" name="buscador" id="buscador" placeholder="Buscar..." autofocus>
                    </div>
                    @forelse($clientes as $key => $cliente)
                        <div class="col-md-6 d-none">
                            <div class="info-box no-underline text-body" style="height: calc(100% - 1rem);"  role="button">
